...
export const DOWNLOAD_LINKS = {
    Android: "https://github.com/Satellite-im/UplinkWeb/releases/download/v2.0.1/Uplink_v2.0.2.apk",
    // iOS: "https://github.com/Satellite-im/UplinkWeb/releases/download/v2.0.1/Uplink.ipa",
    Windows: "https://github.com/Satellite-im/UplinkWeb/releases/download/v2.0.1/Uplink_v2.0.2.msi",
    Mac: "https://github.com/Satellite-im/UplinkWeb/releases/download/v2.0.1/Uplink_v2.0.2.dmg",
    Linux: "https://github.com/Satellite-im/UplinkWeb/releases/download/v2.0.1/Uplink_v2.0.2.deb",
}
